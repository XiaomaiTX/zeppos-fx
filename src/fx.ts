...
export class Fx {
    ...
    static Styles: { [key: string]: number };
    static Easing: { [key: string]: (now_x: number, begin: number, end: number, max_x: number) => number };
    ...
    _getStyleName(styleValue: number): string {
        for (const key in Fx.Styles) {
            if (Fx.Styles[key as keyof typeof Fx.Styles] === styleValue) {
                return key;
            }
        }
        return "LINEAR";
 ...
 */
Fx.Easing = {
    LINEAR: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * x;
    },

    EASE_IN_SINE: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * (1 - Math.cos((x * Math.PI) / 2));
    },

    EASE_OUT_SINE: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * Math.sin((x * Math.PI) / 2);
    },

    EASE_IN_OUT_SINE: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * (-(Math.cos(Math.PI * x) - 1) / 2);
    },

    EASE_IN_QUAD: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * (x * x);
    },

    EASE_OUT_QUAD: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * (1 - (1 - x) * (1 - x));
    },

    EASE_IN_OUT_QUAD: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return (
            begin +
            (end - begin) *
    ...
    EASE_IN_CUBIC: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * (x * x * x);
    },

    EASE_OUT_CUBIC: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * (1 - Math.pow(1 - x, 3));
    },

    EASE_IN_OUT_CUBIC: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return (
            begin +
            (end - begin) *
    ...
    EASE_IN_QUART: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * (x * x * x * x);
    },

    EASE_OUT_QUART: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * (1 - Math.pow(1 - x, 4));
    },

    EASE_IN_OUT_QUART: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return (
            begin +
            (end - begin) *
    ...
    EASE_IN_QUINT: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * (x * x * x * x * x);
    },

    EASE_OUT_QUINT: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * (1 - Math.pow(1 - x, 5));
    },

    EASE_IN_OUT_QUINT: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return (
            begin +
            (end - begin) *
    ...
    EASE_IN_EXPO: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * (x === 0 ? 0 : Math.pow(2, 10 * x - 10));
    },

    EASE_OUT_EXPO: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * (x === 1 ? 1 : 1 - Math.pow(2, -10 * x));
    },

    EASE_IN_OUT_EXPO: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return (
            begin +
            (end - begin) *
    ...
    EASE_IN_CIRC: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * (1 - Math.sqrt(1 - Math.pow(x, 2)));
    },

    EASE_OUT_CIRC: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * Math.sqrt(1 - Math.pow(x - 1, 2));
    },

    EASE_IN_OUT_CIRC: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return (
            begin +
            (end - begin) *
    ...
    EASE_IN_BACK: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        const c1 = 1.70158;
        return begin + (end - begin) * (c1 * x * x * x - c1 * x * x);
    },

    EASE_OUT_BACK: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        const c1 = 1.70158;
        return (
            begin +
    ...
    EASE_IN_OUT_BACK: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        const c1 = 1.70158;
        const c2 = c1 * 1.525;
    ...
    EASE_IN_ELASTIC: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
    ...
    EASE_OUT_ELASTIC: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        const c4 = (2 * Math.PI) / 3;
    ...
    EASE_IN_OUT_ELASTIC: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
    ...
    EASE_IN_BOUNCE: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * (1 - bounceOut(1 - x));
    },

    EASE_OUT_BOUNCE: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return begin + (end - begin) * bounceOut(x);
    },

    EASE_IN_OUT_BOUNCE: function (now_x: number, begin: number, end: number, max_x: number): number {
        const x = now_x / max_x;
        return (
            begin +
            (end - begin) *
